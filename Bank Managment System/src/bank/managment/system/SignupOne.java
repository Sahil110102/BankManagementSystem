...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        personalDetails.setBounds(275,80,400,40);
        add(personalDetails);
        //Name
        ...
        //Fathername
        JLabel fname = new JLabel("Fataher's Name:");
        ...
        //Marital Status
        JLabel mstate = new JLabel("Marital Status:");
    ...
    public void actionPerformed (ActionEvent ae){
        String formno = "" + random;// convert Long value to string
        String name = nameTextField.getText(); //Retrive value from the input
